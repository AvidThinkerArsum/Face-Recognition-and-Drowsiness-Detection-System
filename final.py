...
# EAR, Sound Function, screen shot, email, and text.
# Variables
# Make sure to look at both eyes to avoid one eye winks: being intelligent with computing this.
# Starting the infinite loop. print EAR
# This was recognizing face, capturing features, and detecting drowsiness.
# How to also detect face and compare from system to check person? Does this require a ML Model?
...
cap.release()
    ...
    # load "facial recognition going to start"
    # do facial recognition
    # load 1 minute waiter for drowsiness detection
    # continue drowsiness detection
    
    # alert symbol disappears in a bit
    # screenshot, email, and text need to be added
    # could bring falg count on a separate frame to view simultaneously
    
    # can I do a similar proejct for sign language?
